          ...
          <div class="space-y-4">
            ...
            <div v-if="props.categories && props.categories.length > 0">
              <div class="flex justify-content-evenly gap-4 mt-6">
                ...
                <button
                  @click.stop="ativarCategoria"
                  style="color: #0079d6; cursor: pointer"
                >
            ...
            <div class="flex gap-4 mt-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  class="mt-1 px-3 py-2 w-full border border-gray-300 rounded"
                  title="Estoque minimo para que seja avisado!"
                />
              </div>
            </div>
            <div class="flex gap-4 mt-6">
              ...
              >
                ...
                <template v-else>
                  ...
                  <p class="text-gray-400 text-xs">
                    ...
                    <br />
                    Resolução ideal: 400x400 ou 800x800
                  </p>
                </template>
              </div>
...
const onSearchImage = _debounce(async () => {
  ...
  try {
    ...
    if (
      useGoogleApi.value &&
      images.length === 0 &&
      dailyQueryCount.value < dailyQueryLimit
    ) {
      ...
      const filteredImages = (googleResponse.data.items || []).filter(
        (item) => {
    ...
    if (useInternalApi.value && useGoogleApi.value) {
      try {
        ...
        console.error(
          'Erro na busca de imagens na API do Google:',
          googleError
        );
