    ...
    <transition name="slide">
      ...
      >
        ...
        <div
          ...
          :class="{
            'slide-from-right': isModalOpenEdit,
            'slide-to-right': !isModalOpenEdit,
          }"
        >
          <button
            @click="closeModal"
                  ...
                  <template v-if="imagePreview || form.image_path">
                    <img
                      :src="
                        imagePreview ||
                        '/storage/' +
                          (form.image_path || 'default-product-image.jpg')
                      "
    ...
    handleImageChange(event) {
      ...
      if (file) {
        ...
        if (!validFormats.includes(file.type)) {
          notify.error(
            'Formato inválido! Apenas arquivos JPEG e PNG são permitidos.'
          );
          return;
        }
