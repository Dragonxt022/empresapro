            ...
            <div class="row">
              ...
              <div class="col-12">
                <h1 class="text-2xl font-bold text-sky-500 flex items-center">
                  <!-- Ícone -->
                  <IconBoxPrimary class="h-6 w-6 mr-2" />
                  Produtos
                </h1>
                <div class="mt-4"></div>
                <section class="content">
                    ...
                    <div class="flex justify-between items-center">
                      ...
                      <div class="flex gap-2">
                        ...
                        <transition name="slide">
                          <CadastroCategoria
                            v-if="modalStore.activeComponent === 'categoria'"
                          />
                        </transition>

                        <transition name="slide">
                          <CadastroProduto
                            v-if="modalStore.activeComponent === 'produto'"
                          ...
                          <button
                            ...
                            :class="{
                              'bg-red-500 text-white':
                                selectedProducts.length > 0, // Cor de destaque quando itens estão selecionados
                              'bg-gray-300 text-gray-600':
                                selectedProducts.length === 0, // Cor apagada quando não há itens selecionados
                              'cursor-not-allowed':
                                selectedProducts.length === 0, // Desabilita o botão
                            }"
                        ...
                        >
                            ...
                            <tr>
                              <th class="px-4 py-3">
                                <input
                                  type="checkbox"
                                  @change="
                                    selecionarTodos($event.target.checked)
                                  "
                          ...
                          <tbody>
                            ...
                            >
                              ...
                              <td
                                class="px-3 py-2 text-center hidden md:table-cell"
                              >
                                {{ product.category }}
                              </td>
                              <td
...
import IconBoxPrimary from '@/Components/Icons/IconBoxPrimary.vue';
